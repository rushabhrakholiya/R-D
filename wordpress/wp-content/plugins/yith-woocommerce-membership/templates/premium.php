...
.section.two{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/02-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.three{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/03-bg.png) no-repeat #fff; background-position: 85% 75%;
}
.section.four{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/04-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.five{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/05-bg.png) no-repeat #fff; background-position: 85% 75%;
}
.section.six{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/06-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.seven{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/07-bg.png) no-repeat #fff; background-position: 85% 75%;
}
.section.eight{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/08-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.nine{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/09-bg.png) no-repeat #fff; background-position: 85% 75%;
}
.section.ten{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/10-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.eleven{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/11-bg.png) no-repeat #fff; background-position: 85% 75%;
}
.section.twelve{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/12-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.thirteen{
...
.section.sixteen{
    background: url(<?php echo YITH_WCMBS_ASSETS_URL ?>/images/16-bg.png) no-repeat #fff; background-position: 15% 100%;
}
.section.seventeen{
