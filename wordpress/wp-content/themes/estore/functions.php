...
/*start code for exclude package product from shop page 
/**
	...
	if ( is_shop() && $query->is_main_query() ) { 
		$query->set( 'tax_query', array(
			array(
				...
				'field' => 'ID',
				'terms' => array( intval(get_field('package_category_global','option')) ),
				'operator' => 'NOT IN'
			)
		) );
...
/*end code for exclude pacakage product from shop page */